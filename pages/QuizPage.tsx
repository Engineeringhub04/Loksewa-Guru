...
const OldQuizCategoryCard: React.FC<{ category: QuizCategory }> = ({ category }) => {
    ...
    const handleClick = () => {
        ...
        const { login: loginRequired, subscription: subscriptionRequired } = subscriptionLocks['mcq-test'] || {};
...
const PracticeCategoryCard: React.FC = () => {
    ...
    const handleClick = () => {
        const { login: loginRequired, subscription: subscriptionRequired } = subscriptionLocks['questions-practice'] || {};
