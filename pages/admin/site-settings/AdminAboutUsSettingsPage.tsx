...
const AdminAboutUsSettingsPage: React.FC = () => {
    ...
    const docRef = useCallback(() => doc(db, 'pageContent', 'about-us'), []);
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div>
                <label htmlFor="about-content" className="block text-sm font-medium">Page Content (HTML supported)</label>
                <p className="text-xs text-gray-500 mb-2">Use HTML tags like `&lt;h2&gt;`, `&lt;p&gt;`, `&lt;ul&gt;`, `&lt;li&gt;` for formatting.</p>
                <textarea
                    id="about-content"
                    value={content}
...
export default AdminAboutUsSettingsPage;